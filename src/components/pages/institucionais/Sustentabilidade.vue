        ...
        <div class="space-y-5 md:space-y-8">
          ...
          <blockquote class="text-center p-4 sm:px-7">
            <p class="text-xl font-medium text-gray-800 md:text-2xl md:leading-normal xl:text-2xl xl:leading-normal dark:text-gray-200">
              ...
              um futuro mais verde e justo para todos os envolvidos na cadeia produtiva.
            </p>
          ...
          <div class="space-y-3">
            ...
            <p class="text-lg text-gray-800 dark:text-gray-200">
              ...
              recuperação de áreas degradadas são alguns exemplos de ações que beneficiam o planeta e
      ...
      <div class="inline-block bg-white shadow-md rounded-full py-3 px-4 dark:bg-gray-800">
        <div class="flex items-center gap-x-1.5">
          ...
          <div class="hs-dropdown relative inline-flex">
            ...
            <div class="hs-dropdown-menu w-auto transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mb-1 z-10 bg-gray-50 shadow-md rounded-xl p-2" aria-labelledby="blog-article-share-dropdown">
              <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-600 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gray-400 hover:bg-gray-400 hover:text-gray-50" href="#">
